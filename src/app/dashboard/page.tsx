              ...
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">App Status</dt>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">Shopify Plan</dt>
                      <dd className="text-lg font-medium text-gray-900">{shopData.plan_name}</dd>
                    </dl>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">Store Currency</dt>
                      <dd className="text-lg font-medium text-gray-900">{shopData.currency}</dd>
                    </dl>
                  </div>
                </div>
              </div>
